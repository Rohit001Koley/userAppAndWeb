...
import 'package:flutter_grocery/common/widgets/discount_tag.dart';
...
class ProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final discountValue = PriceConverterHelper.convertProductDiscount(price: product.price, discount: product.discount, discountType: product.discountType, categoryDiscount: product.categoryDiscount);
        ...
        return isGrid
            ...
            : Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () => RouteHelper.getProductDetailsRoute(productId: product.id, formSearch: productType == ProductType.searchItem),
                            ...
                            children: [
                              ...
                              product.price != discountValue.discount
                                  ? Positioned(
                                      top: 5,
                                      left: 5,
                                      child: DiscountTag(product: product, discountType: discountValue.type),
                                    )
                                  : const SizedBox(),
                                            ...
                                            InkWell(
                                              onTap: () {
                                                if (product.variations == null || product.variations!.isEmpty) {
                                                  ...
                                                  RouteHelper.getProductDetailsRoute(productId: product.id, formSearch: productType == ProductType.searchItem);
                                                }
                                              },
                                              child: Container(
                                                ...
                                                child: Icon(Icons.shopping_cart_outlined, color: Theme.of(context).primaryColor, size: Dimensions.paddingSizeLarge),
                                              ),
                                            ),
                                                ...
                                                InkWell(
                                                  ...
                                                  child: RotatedBox(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Icon(Icons.remove, size: Dimensions.paddingSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color),
                                                    ),
                                                  ),
                                                ),
                                ...
                                children: [
                                  product.rating != null
                                      ? Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              (product.activeReviewsCount != null && product.activeReviewsCount! > 0) ? '( ${product.activeReviewsCount} )' : '',
                                              style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                            ),
                                          ],
                                        )
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                      ProductPointValueWidget(pointValue: product.pointValue, compact: true),
                                    ],
                                  ),
                                              ...
                                              if ((product.price ?? 0) > priceWithDiscount)
                                                TextSpan(
                                                  style: poppinsRegular.copyWith(
                                                    fontSize: ResponsiveHelper.getPhoneSize() == PhoneSize.smallPhone ? Dimensions.fontSizeSmall : Dimensions.fontSizeDefault,
                                        ...
                                        child: FittedBox(
                                          child: Row(
                                            children: [
                                              ...
                                              CustomDirectionalityWidget(
                                                child: Text(PriceConverterHelper.convertPrice(context, priceWithDiscount), style: poppinsSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                              ),
                                            ],
                                          ),
                                        ),
            ...
            product.price != priceWithDiscount
                ? Positioned.fill(
                    ...
                    child: Align(
                      ...
                      child: DiscountTag(product: product, discountType: discountType!),
                    ),
                  )
                : const SizedBox(),
                              ...
                              Positioned.fill(
                                child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    padding: const EdgeInsets.all(6),
                                    decoration: BoxDecoration(shape: BoxShape.circle, color: Theme.of(context).primaryColor),
                                    child: Text('${Provider.of<CartProvider>(context).getCartQuantityByProductId(product.id!)}', style: TextStyle(color: Theme.of(context).cardColor, fontSize: 10)),
                                  ),
                                ),
                              ),
                          ],
