...
class CustomPopScopeWidget extends StatefulWidget {
  ...
  const CustomPopScopeWidget({super.key, required this.child, this.onPopInvoked, this.drawerController});
      ...
      onPopInvokedWithResult: (bool didPop, _) {
        ...
        if (!didPop && (splashProvider.pageIndex == 0) && (!context.canPop())) {
          ...
          if(_clickCont >= 2){
            ...
            showCustomSnackBarHelper(getTranslated("double_press_to_exit", context));
          }
        }
