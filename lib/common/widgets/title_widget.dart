...
class TitleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: ResponsiveHelper.isDesktop(context) ? 0 : 15, vertical: ResponsiveHelper.isDesktop(context) ? 12 : 14),
            ...
            builder: (bool isHovered)=> Padding(
              ...
              child: Text(
                ...
                style: poppinsRegular.copyWith(
                  ...
                  color: isHovered ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.8),
                ),
              ),
            )),
        ) : const SizedBox(),
