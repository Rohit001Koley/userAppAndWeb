  ...
  Widget build(BuildContext context) {
    return Consumer<CategoryProvider>(
      ...
      leading: isBackButtonExist ? IconButton(
        icon: Icon(Icons.arrow_back_ios_outlined, color: Theme.of(context).textTheme.bodyLarge!.color),
      ...
      actions: [
          ...
          PopupMenuButton(
            ...
            onSelected: (dynamic value) {
              ...
              if(index >= 0) {
                ...
                Provider.of<ProductProvider>(context, listen: false).getItemList(1, productType: productType, sortBy: value);
              }
            },
            itemBuilder: (context) {
        ...
        fromCategory ? IconButton(icon: Icon(Icons.more_vert, color: Theme.of(context).textTheme.bodyLarge!.color),
          onPressed: () {
