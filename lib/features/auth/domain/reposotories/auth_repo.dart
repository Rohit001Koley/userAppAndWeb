...
class AuthRepo {
  ...
  Future<void> subscribeTokenToTopic({required String token, required String topic}) async {
  ...
  Future<void> subscribeToAppTopic(String deviceToken) async {
    if(!kIsWeb){
      ...
      await subscribeTokenToTopic(token: deviceToken, topic: AppConstants.topic);
    }
  }
