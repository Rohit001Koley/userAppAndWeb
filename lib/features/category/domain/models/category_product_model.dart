...
class CategoryProductModel {
  ...
  CategoryProductModel.fromJson(Map<String, dynamic> json) {
    ...
    filterPriceLow = double.tryParse('${json['lowest_price']}') ?? double.tryParse('${json['min_price']}');
    filterPriceHigh = double.tryParse('${json['highest_price']}') ?? double.tryParse('${json['max_price']}');
    sortBy = json['sort_by'];
