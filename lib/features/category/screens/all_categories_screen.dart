...
class _AllCategoriesScreenState extends State<AllCategoriesScreen> {
  ...
  void _filterCategories() {
    ...
    if(query.isEmpty) {
      ...
      _filteredCategoriesNotifier.value = categoryProvider.categoryList?.where((category) {
    ...
    return CustomPopScopeHandelDeepLinkWidget(
      child: Scaffold(
        appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(120), child: WebAppBarWidget())
            : CustomAppBarWidget(title: getTranslated('category', context)) as PreferredSizeWidget,
            ...
            children: [
              Center(child: SizedBox(
                ...
                builder: (context, categoryProvider, child) {
                  ...
                  ) : categoryProvider.categoryList?.isNotEmpty ?? false ? ResponsiveHelper.isDesktop(context)?
                  Column(
                    children: [
                      SizedBox(height: Dimensions.paddingSizeDefault*2),
                      Row(
                        children: [
                            ...
                            child: Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: getTranslated('search_for_category', context),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(Dimensions.radiusSizeLarge*4),
