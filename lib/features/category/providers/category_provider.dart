...
class CategoryProvider extends ChangeNotifier  {
  ...
  void getCategoryProductList(String categoryID, int offset, {double? priceLow, double? priceHigh, String? sortBy, int? rating}) async {
    ApiResponseModel apiResponse = await productRepo.getBrandOrCategoryProductList(
      categoryID,
      offset,
      priceLow: priceLow,
      priceHigh: priceHigh,
  ...
  bool get hasActiveFilters => _filterPriceLow != null || _filterPriceHigh != null || _sortBy != null || _rating != null;
  ...
  void initCategoryProductList(String id, int offset, {double? priceLow, double? priceHigh, String? sortBy, int? rating}) async {
    if(offset == 1){
      _subCategoryProductList = null;
      _hasData = true;
      notifyListeners();
