  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: InkWell(
        ...
        child: Stack(
          children: [
            const Positioned(top: 0, bottom: 0, right: 0, left: 0, child: Icon(Icons.delete, color: Colors.white, size: 50)),
            Dismissible(
              key: UniqueKey(),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 900 : 200]!, blurRadius: 5, spreadRadius: 1)],
                ),
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: CustomImageWidget(
                          ...
                          height: ResponsiveHelper.isDesktop(context) ? 100 : 70,
                                  ...
                                  child: Row(
                                    children: [
                                      Flexible(
                                        child: Text(
                                          '${cart.capacity} ${cart.unit}',
                                          style: poppinsMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      ),
                    ...
                    RotatedBox(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: Theme.of(context).disabledColor.withValues(alpha: 0.05), borderRadius: BorderRadius.circular(10)),
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: ResponsiveHelper.isMobile() ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeExtraLarge),
                            ...
                            RotatedBox(
                              quarterTurns: ResponsiveHelper.isMobile() ? 0 : 1,
                              child: (ResponsiveHelper.isDesktop(context) && cart.quantity == 1)
                                  ? IconButton(
                                  ...
                                  : InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(color: Theme.of(context).canvasColor, shape: BoxShape.circle),
                                        padding: EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
