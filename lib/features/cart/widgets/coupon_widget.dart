            ...
            child: SizedBox(height: 50, child: Row(children: [
              ...
              Expanded(child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: widget.couponController.text.isNotEmpty && couponProvider.discount == 0
                    ? IconButton(
              ...
              InkWell(
                onTap: () {
                  if (widget.couponController.text.isNotEmpty && !couponProvider.isLoading) {
                    if (couponProvider.discount! < 1) {
                      couponProvider.applyCoupon(widget.couponController.text, widget.discountedPrice);
                    } else {
                      couponProvider.removeCouponData(true);
                    }
                  }
                  else if(widget.couponController.text.trim().isEmpty){
                    showCustomSnackBarHelper(getTranslated('please_enter_a_coupon_first', context),isError: true);
                  }
                  else {
