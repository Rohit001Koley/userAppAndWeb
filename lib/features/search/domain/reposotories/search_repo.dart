...
class SearchRepo {
  ...
  Future<ApiResponseModel> getSearchProductList({
    ...
    final Map<String, dynamic> params = {
      ...
      'sort_by': ?sortBy,
      'rating': ?rating,
      if (categories != null && categories.isNotEmpty) 'category_ids': jsonEncode(categories),
    };

    try {
      final response = await dioClient!.get(AppConstants.searchUri, queryParameters: params);
