...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData() async {
    ...
    if(widget.orderId != null){
      ...
      PaymentResponseModel? paymentResponse = await orderProvider.getDigitalPaymentResponse(transactionId: transactionId);
      if (!mounted) return;
      if(paymentResponse?.orderId != null){
         ...
         orderProvider.trackOrder(paymentResponse.orderId!, null, context, false, phoneNumber: widget.phoneNumber, isUpdate: false);
