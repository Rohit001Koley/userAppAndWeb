...
class _TrackRefreshButtonView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<OrderProvider>(builder: (context, orderProvider, _) {
      final bool hasContent = orderIdTextController.text.isNotEmpty || phoneNumberTextController.text.isNotEmpty || (orderProvider.trackModel != null && orderProvider.trackModel?.id != null);
