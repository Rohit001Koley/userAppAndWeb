    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: OrderStatus.pending.name == orderList![index].orderStatus ? ColorResources.colorBlue.withValues(alpha: 0.08)
            : OrderStatus.outForDelivery.name == orderList![index].orderStatus ? ColorResources.ratingColor.withValues(alpha: 0.08)
      ...
      child: Text(
        ...
        style: poppinsRegular.copyWith(color: OrderStatus.pending.name == orderList![index].orderStatus ? ColorResources.colorBlue
            : OrderStatus.outForDelivery.name == orderList![index].orderStatus ? ColorResources.ratingColor
