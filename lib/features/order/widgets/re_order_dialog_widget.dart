      ...
      builder: (context, orderProvider, _) {
        return Dialog(
          child: Container(
            ...
            decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: const BorderRadius.all(Radius.circular(Dimensions.radiusSizeLarge))),
            width: 600,
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: CustomSingleChildListWidget(
                    ...
                    itemBuilder: (index) {
                      return Column(
                        ...
                        children: [
                          ReOrderProductItem(cart: orderProvider.reOrderCartList[index], index: index, orderDetailsModel: orderProvider.orderDetails![index]),
                ...
                Row(
                  children: [
                    Expanded(
                      child: CustomButtonWidget(backgroundColor: Theme.of(context).disabledColor, buttonText: getTranslated('cancel', context), onPressed: () => Navigator.pop(context)),
                    ),
...
class ReOrderProductItem extends StatelessWidget {
  ...
  final int index;
  const ReOrderProductItem({super.key, required this.cart, required this.index, required this.orderDetailsModel});
                          ...
                          children: [
                            Expanded(
                              child: CustomDirectionalityWidget(
                                child: Text(PriceConverterHelper.convertPrice(context, cart.price), style: poppinsSemiBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                              ),
                            ),
              ...
              Positioned.fill(
                child: Align(
                  ...
                  child: ReOrderTagView(
                    ...
                    borderRadius: const BorderRadius.only(topLeft: Radius.circular(Dimensions.radiusSizeDefault), bottomRight: Radius.circular(Dimensions.radiusSizeLarge)),
                  ),
                ),
              ),
            ...
            Positioned.fill(
              child: Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(shape: BoxShape.circle, color: isProductNotAvailable ? Theme.of(context).colorScheme.error : Theme.of(context).primaryColor),
                  child: Icon(isProductNotAvailable ? Icons.not_interested_outlined : Icons.done_outlined, color: Colors.white, size: Dimensions.paddingSizeLarge),
                ),
              ),
            ),
            ...
            if (isProductNotAvailable)
              Positioned.fill(
                child: Align(
                  ...
                  child: ReOrderTagView(message: getTranslated((cart.stock != null && cart.stock! < 1) ? 'out_of_stock' : 'already_added', context)),
                ),
              ),
          ],
        );
...
class ReOrderTagView extends StatelessWidget {
  ...
  const ReOrderTagView({super.key, this.borderRadius, this.color, required this.message});

  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: borderRadius ?? const BorderRadius.only(topLeft: Radius.circular(Dimensions.radiusSizeLarge), bottomRight: Radius.circular(Dimensions.radiusSizeDefault)),
      ...
      child: Text(
        message,
        style: poppinsLight.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white),
      ),
    );
  }
}
