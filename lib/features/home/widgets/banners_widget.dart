        ...
        return Column(
          children: [
            Container(
              ...
              height: ResponsiveHelper.isDesktop(context) ? 210 : ResponsiveHelper.isTab(context) ? 210 : size.width * 0.49,
              padding: (ResponsiveHelper.isDesktop(context) || ResponsiveHelper.isTab(context)) ? const EdgeInsets.only(top: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeSmall) : null,
                ...
                children: [
                  CarouselSlider.builder(
                    options: CarouselOptions(
                      ...
                      viewportFraction: ResponsiveHelper.isDesktop(context) ? 0.33 : ResponsiveHelper.isTab(context) ? 0.5 : 1,
                      enlargeFactor: 0,
                      disableCenter: true,
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImageWidget(
                              height: ResponsiveHelper.isDesktop(context) ? 210 : ResponsiveHelper.isTab(context) ? 210 : size.width * 0.5,
                              width: ResponsiveHelper.isDesktop(context) ? 400 : ResponsiveHelper.isTab(context) ? size.width * 0.5 : size.width,
                 ...
                 if(!ResponsiveHelper.isDesktop(context) && !ResponsiveHelper.isTab(context)) const Positioned(
            ...
            if(ResponsiveHelper.isDesktop(context) || ResponsiveHelper.isTab(context)) const Padding(
