                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: Text('${(categoryProvider.categoryList?.length ?? 0) - 12}+',
                                  style: poppinsRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeMaxLarge)),
                            ),
                          ),
                        ),
