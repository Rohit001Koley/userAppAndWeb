    ...
    return Consumer<CategoryProvider>(builder: (context, categoryProvider, child) {
      ...
      return categoryProvider.categoryList == null ? const CategoriesShimmerWidget() : (categoryProvider.categoryList?.isNotEmpty ?? false) ? Column(children: [
        ...
        ResponsiveHelper.isDesktop(context) ? CategoryWebWidget(scrollController: scrollController) : GridView.builder(
          itemCount: (categoryProvider.categoryList?.length ?? 0) > 8 ? 9 : categoryProvider.categoryList?.length,
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            mainAxisSpacing: 10,
            crossAxisSpacing: 6,
            childAspectRatio: ResponsiveHelper.isMobile() ? ResponsiveHelper.getPhoneSize() == PhoneSize.smallPhone ? 0.5 :  0.9 : width > 1000 ? 1.8 : 1.4 ,
          ),
                ...
                child: Column(children: [
                  Expanded(flex: 6, child: Container(
                    ...
                    child: index != 8 ? Center(
                      ...
                      alignment: Alignment.center,
                      child: Text('${(categoryProvider.categoryList?.length ?? 0) - 8}+', style: poppinsRegular.copyWith(color: Theme.of(context).cardColor)),
                    ),
                  )),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        index != 8 ? categoryProvider.categoryList![index].name! : getTranslated('view_all', context),
