...
class _ProductDetailsScreenState extends State<ProductDetailsScreen>  with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    productProvider.getProductDetails('${widget.productId}', searchQuery: widget.fromSearch!).then((_){
                                  ...
                                  Padding(
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        (productProvider.product?.discount != null && productProvider.product!.discount! > 0) ? Positioned(
                                          top: 10, left: 10,
                                          child: DiscountTag(product: productProvider.product!, discountType: DiscountType.productDiscount),
                                        ) : const SizedBox(),
                              ...
                              Expanded(flex: 6,child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if(priceWithQuantityWithoutDiscount > priceWithQuantity) Text("Save ${PriceConverterHelper.convertPrice(context, priceWithQuantityWithoutDiscount - priceWithQuantity)} on this item",
