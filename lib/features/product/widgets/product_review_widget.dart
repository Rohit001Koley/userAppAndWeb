            ...
            Row(children: [
                ...
                if(review?.createdAt != null)
                  Row(
                    ...
                    children: [
                      Text(DateConverterHelper.getDateToDateDifference(DateConverterHelper.convertStringToDatetime(review?.createdAt ?? ''), context)),
                      SizedBox(width: Dimensions.paddingSizeExtraSmall),
                      Text(DateConverterHelper.isoStringToLocalTimeOnly(review?.createdAt ?? '')),
                    ],
                  ),
              ]),
