  ...
  Widget build(BuildContext context) {
    return Consumer<ProductProvider>(builder: (context, productProvider, _) {
      return Column(crossAxisAlignment:CrossAxisAlignment.start, children: [
        ...
        tabIndex == 0 && showDescription? Stack(children: [
          Container(
            ...
            child: SingleChildScrollView(
              ...
              child: HtmlWidget(
                !isHtmlContentEmpty(productProvider.product?.description)? (productProvider.product!.description!) : getTranslated('no_description', context),
          ...
          if( (productProvider.product?.description?.length ?? 0) > (ResponsiveHelper.isDesktop(context) ? 1200 : 500) && showSeeMoreButton) Positioned.fill(child: Align(
          ...
          if((productProvider.product?.description?.length ?? 0) > (ResponsiveHelper.isDesktop(context) ? 1200 : 500)) Positioned.fill(child: Align(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                margin: showSeeMoreButton ? const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall) : null,
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Icon(
                    showSeeMoreButton ? Icons.keyboard_arrow_down_rounded : Icons.keyboard_arrow_up_rounded,
                    size: 18,
                    color: Theme.of(context).primaryColor,
                  ),
                ]),
          ...
          (productProvider.productReviews?.reviewList?.isEmpty ?? true) ? Padding(
            padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraLarge * 2),
            child: Center(
              child: Text(
                getTranslated('no_review_is_available', context),
                style: poppinsRegular.copyWith(
