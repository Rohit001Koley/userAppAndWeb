...
class ProductTitleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (startingPriceWithCategoryDiscount != null && startingPriceWithCategoryDiscount > 0 && startingPriceWithCategoryDiscount < startingPriceWithDiscount!) {
      ...
      builder: (context, productProvider, child) {
        return Padding(
          padding: EdgeInsets.only(
            right: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeLarge,
            top: ResponsiveHelper.isDesktop(context) ? 0 : Dimensions.paddingSizeLarge,
            left: ResponsiveHelper.isDesktop(context) ? 0 : Dimensions.paddingSizeLarge,
          ),
          child: Column(
            ...
            children: [
                ...
                children: [
                  product?.rating != null
                      ? Container(
                          ...
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: ColorResources.ratingColor.withValues(alpha: 0.1)),
                          child: Row(
                  ...
                  ProductPointValueWidget(pointValue: product!.pointValue),
                ],
              ),
              ...
              Text(
                ...
                style: poppinsMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.70), fontSize: Dimensions.fontSizeDefault),
              ),
              SizedBox(height: Dimensions.paddingSizeLarge),
              Text(
                'unit'.tr,
                style: poppinsRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeDefault),
              ),
              //Product Price
              Row(
                children: [
                  startingPriceWithDiscount! < startingPrice!
                      ? CustomDirectionalityWidget(
                          child: Text(
                            ...
                            style: poppinsRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                          ),
                        )
                      : const SizedBox(),
