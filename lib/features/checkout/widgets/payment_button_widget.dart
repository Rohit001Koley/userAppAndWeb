    ...
    return Container(
      ...
      child: Column( mainAxisAlignment: MainAxisAlignment.center, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          PriceConverterHelper.convertAnimationPrice(context, paidAmount,
            textStyle: isPartialPayment ? poppinsRegular.copyWith(
              color: Theme.of(context).textTheme.bodySmall?.color?.withValues(alpha: 0.7) ,
        ...
        if(isPartialPayment) Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          PriceConverterHelper.convertAnimationPrice(context, remainingBill,
            textStyle: poppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
          ),
        ]),
        ...
        child: Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Row( children: [
                PriceConverterHelper.convertAnimationPrice(context, walletPaymentStatus ? remainingWalletBalance : walletBalance,
                  textStyle: poppinsMedium.copyWith(overflow: TextOverflow.ellipsis, fontSize: Dimensions.fontSizeExtraLarge,),
                ),
