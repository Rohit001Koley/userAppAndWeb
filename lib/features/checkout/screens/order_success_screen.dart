  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: ResponsiveHelper.isDesktop(context) ? const PreferredSize(preferredSize: Size.fromHeight(120), child: WebAppBarWidget()): CustomAppBarWidget(title: getTranslated("order_confirmation", context)),
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        if(widget.status == 0 && widget.orderID != 'null') Column(children: [
                          RichText(
                            ...
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: '${getTranslated('your_order_id', context)} ',
                        ...
                        if(widget.status == 0) Padding(
                          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                          child: Text(
                            getTranslated('order_success_message', context),
                            style: poppinsRegular.copyWith(
                        ...
                        if(widget.status == 0) SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: CustomButtonWidget(
                              ...
                              buttonText: getTranslated('download_invoice', context),
                              onPressed: () {
                                String url = '${AppConstants.baseUrl}${AppConstants.orderInvoiceUri}/${widget.orderID}';
                        ...
                        if(widget.status != 0) SizedBox(width: MediaQuery.of(context).size.width, child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                          child: CustomButtonWidget(
