                     ...
                     if(messages!.message != null) Flexible(
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: _BuildMessageText(message: messages!.message??'', context: context),
                          ),
                        ),
                      ),
                     if( messages!.attachment !=null) const SizedBox(height: Dimensions.paddingSizeSmall),
                      messages!.attachment !=null? GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, index){
                          ...
                          final String imageUrl = messages!.attachment![index];
                          return  (messages!.attachment!.isNotEmpty)?
                          Padding(
                            padding: EdgeInsets.all(isDesktop ? 4.0 : 0.0),
                            child: InkWell(
                              onTap: () => showDialog(context: context, builder: (ctx)  =>  ImageDialogWidget(imageUrl: imageUrl), ),
                              child: ClipRRect(
                        ...
                        messages!.attachment !=null? Directionality(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, index){
                              ...
                              return  (messages!.attachment!.isNotEmpty) ?
                              Padding(
                                padding: ResponsiveHelper.isDesktop(context) ? const EdgeInsets.all(8.0) : EdgeInsets.zero,
                                child: InkWell(
                                  onTap: () => showDialog(context: context, builder: (ctx)  =>  ImageDialogWidget(imageUrl: imageUrl), ),
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(5),
                      ...
                      if(messages!.reply != null && messages!.reply!.isNotEmpty)  Flexible(
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: _BuildMessageText(message: messages!.reply??'', context: context),
                            ),
                          ),
                        ),
