...
class ChatProvider extends ChangeNotifier {
  ...
  void onPickImage(BuildContext context, bool isRemove) async {
    if (isRemove) {
      ...
      final List<XFile> pickedImages = await FileValidationHelper.validateAndPickMultipleImages(
        context: context,
      );
      ...
      if (pickedImages.isNotEmpty) {
        ...
        for (final XFile image in pickedImages) {
          final bool alreadyAdded = _chatImage!.any((existing) => existing.path == image.path);
          if (!alreadyAdded) {
