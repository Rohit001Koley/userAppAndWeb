...
import 'package:flutter_grocery/features/chat/widgets/emoji_picker_widget.dart';
                          ...
                          child: Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    isAdmin ? "conversation".tr : widget.userName,
          ...
          children: [
            ...
            Consumer<ChatProvider>(builder: (context, chatProvider, _) {
              return Offstage(
                ...
                child: SizedBox(
                  height: 250,
                  child: EmojiPickerWidget(textEditingController: _inputMessageController),
                ),
              );
            }),
          ],
        ...
        child: Column(children: [
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: ResponsiveHelper.isWeb()
                                ? Image.network(chatProvider.chatImage![index].path, width: 100, height: 100, fit: BoxFit.cover)
                                : Image.file(File(chatProvider.chatImage![index].path), width: 100, height: 100, fit: BoxFit.cover),
                          ),
                        ),
                        Positioned(
                          top: 0,
          ...
          SizedBox(
            ...
            child: Row(children: [
              ...
              SizedBox(height: 25, child: VerticalDivider(width: 0, thickness: 1, color: Theme.of(context).hintColor)),
              ...
              Consumer<ChatProvider>(builder: (context, chatProvider, _) {
                return IconButton(
                  ...
                  icon: Icon(
                    chatProvider.isEmojiPickerVisible ? Icons.keyboard : Icons.emoji_emotions_outlined,
                  ),
                );
              }),
                ...
                return InkWell(
                  onTap: chatProvider.isLoading ? null : () async {
                    if (chatProvider.isSendButtonActive) {
                      ...
                      showCustomSnackBarHelper('write_somethings'.tr);
                    }
                  },
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text('select_emoji'.tr, style: poppinsMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.of(dialogContext).pop()),
                  ],
                ),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                Expanded(child: EmojiPickerWidget(textEditingController: _inputMessageController)),
              ],
            ),
          ),
        );
