...
class _LoyaltyScreenState extends State<LoyaltyScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      scrollController.addListener(() {
        if (scrollController.position.pixels == scrollController.position.maxScrollExtent && walletProvide.transactionList != null && !walletProvide.isLoading) {
          ...
          if (walletProvide.offset < pageSize) {
            ...
            walletProvide.getLoyaltyTransactionList(walletProvide.offset.toString(), false, false, isEarning: walletProvide.selectedTabButtonIndex == 1);
          }
        }
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle(statusBarColor: Theme.of(context).primaryColor.withValues(alpha: 0.2)),
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        CustomDirectionalityWidget(
                                                          child: Text('${profileProvider.userInfoModel?.point ?? 0}', style: poppinsBold.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
                                                        ),
                                                      ],
                                                    ),
                                                    const SizedBox(height: Dimensions.paddingSizeDefault),

                                                    Text(getTranslated('withdrawable_point', context), style: poppinsBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                                    const SizedBox(height: Dimensions.paddingSizeDefault),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: ConstrainedBox(
                                                        ...
                                                        child: MemberPointStatusWidget(userInfoModel: profileProvider.userInfoModel, memberStatusModel: profileProvider.memberStatusModel, compact: true),
                                                      ),
                                                    ),
                                                    const SizedBox(height: Dimensions.paddingSizeDefault),
                                                    ...
                                                    SingleChildScrollView(
                                                      ...
                                                      child: Row(
                                                        mainAxisAlignment: MainAxisAlignment.center,
                                                        children: tabButtonList.map((tabButtonModel) => TabButtonWidget(tabButtonModel: tabButtonModel)).toList(),
                                                      ),
                                                    ),
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        Column(
                                                          ...
                                                          children: [
                                                            if (walletProvider.selectedTabButtonIndex == 0) const ConvertMoneyWidget(),
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                walletProvider.transactionList != null
                                                                                    ? walletProvider.transactionList!.isNotEmpty
                                                                                          ? GridView.builder(
                                                                                              key: UniqueKey(),
                                                                                              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisSpacing: 50, mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeLarge : 0.01, childAspectRatio: ResponsiveHelper.isDesktop(context) ? 5 : 4, crossAxisCount: ResponsiveHelper.isMobile() ? 1 : 2, mainAxisExtent: 90),
                                                                                              ...
                                                                                              itemBuilder: (context, index) {
                                                                                                return HistoryWidget(index: index, formEarning: walletProvider.selectedTabButtonIndex == 1, data: walletProvider.transactionList);
                                                                                              },
                                                                                            )
...
class WalletShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      key: UniqueKey(),
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisSpacing: 50, mainAxisSpacing: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeLarge : 0.01, childAspectRatio: ResponsiveHelper.isDesktop(context) ? 4.6 : 3.5, crossAxisCount: ResponsiveHelper.isMobile() ? 1 : 2),
      physics: const NeverScrollableScrollPhysics(),
      shrinkWrap: true,
      itemCount: 10,
      padding: EdgeInsets.only(top: ResponsiveHelper.isDesktop(context) ? 28 : 25),
