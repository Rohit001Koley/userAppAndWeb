...
class PriceConverterHelper {
  ...
  static Widget convertAnimationPrice(BuildContext context, double? price, {double? discount, String? discountType, TextStyle? textStyle}) {
    if(discount != null && discountType != null){
      if(discountType == 'amount') {
        price = price! - discount;
      }else if(discountType == 'percent') {
    ...
    return Directionality(
      ...
      child: Row(
        ...
        children: [
          if(isLeft) Text(config.currencySymbol ?? '', style: textStyle ?? poppinsMedium),
